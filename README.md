...
- Thirty vehicles (six parked, 24 AI) and 34 pedestrians. Inter-district traffic crosses the bridges and follows the mountain and coastal roads.
...
The saved scenery is merged into 128 spatial/material render batches before distance culling, while a spatial index limits static collision queries to nearby objects. Terrain loads in mesh chunks; none of this changes the baked map layout.
